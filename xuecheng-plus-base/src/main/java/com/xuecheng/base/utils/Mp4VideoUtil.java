...
//        ProcessBuilder builder = new ProcessBuilder();
//        builder.command("D:\\Software\\QQ\\Bin\\QQScLauncher.exe");
//        builder.redirectErrorStream(true);
//        Process p = builder.start();

        //ffmpeg的路径
        String ffmpeg_path = "E:\\资料\\黑马java全套视频\\第5阶段—项目实战\\1、黑马程序员Java项目《学成在线》企业级开发实战\\学成在线项目-资料\\day01 项目介绍 项目搭建\\软件工具\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "C:\\Users\\Yang Hui\\Desktop\\python\\1a.avi";
        //转换后mp4文件的名称
        String mp4_name = "nacos01.mp4";
        //转换后mp4文件的路径
        String mp4_path = "C:\\Users\\Yang Hui\\Desktop\\python\\nacos01.mp4";
        //创建工具类对象
